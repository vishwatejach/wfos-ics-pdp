...
public class JrgripHcdBehaviorFactory extends JComponentHandlers {

    private final JCswContext cswCtx;
    private final ILogger log;

    JrgripHcdBehaviorFactory(ActorContext<TopLevelActorMessage> ctx,JCswContext cswCtx) {
        super(ctx, cswCtx);
        this.cswCtx = cswCtx;
    ...
    log.info("Initializing rotator HCD...");
    }
