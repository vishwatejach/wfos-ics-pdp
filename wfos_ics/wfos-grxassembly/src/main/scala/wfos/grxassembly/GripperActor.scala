...
import wfos.grxassembly.models.{AssemblyConfiguration, GripperCommand}
import wfos.grxassembly.models.GripperCommand.MoveStep
import wfos.grxassembly.models.{BluegrxPosition, GripperPosition}
import wfos.grxassembly.events.{GrxPositionEvent, BlueGrxPositionEvent}
...
abstract class GripperActor(cswContext: CswContext, configuration: AssemblyConfiguration) {
  ...
  val gripperPositionEvent: GrxPositionEvent
  val name: String
//
