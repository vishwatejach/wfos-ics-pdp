...
public class JbgrxassemblyBehaviorFactory extends JComponentHandlers {

    private final JCswContext cswCtx;
    private final ILogger log;

    JbgrxassemblyBehaviorFactory(ActorContext<TopLevelActorMessage> ctx, JCswContext cswCtx) 
    {
        super(ctx, cswCtx);
        this.cswCtx = cswCtx;
