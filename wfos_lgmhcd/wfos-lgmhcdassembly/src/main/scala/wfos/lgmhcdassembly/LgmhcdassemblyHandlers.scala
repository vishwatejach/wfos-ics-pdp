 ...
 */
class LgmhcdassemblyHandlers(ctx: ActorContext[TopLevelActorMessage], cswCtx: CswContext) extends ComponentHandlers(ctx, cswCtx) {
  ...
  override def initialize(): Unit = {
    log.info("Initializing lgmHcdAssembly...")
  }
